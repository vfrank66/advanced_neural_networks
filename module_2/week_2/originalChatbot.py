...
class ChatBot():
    ...
    def __init__(self):
        ...
        """
        self.input_word2idx = np.load('originalmodel/word-input-word2idx.npy').item()
        self.input_idx2word = np.load('originalmodel/word-input-idx2word.npy').item()
        self.target_word2idx = np.load('originalmodel/word-target-word2idx.npy').item()
        self.target_idx2word = np.load('originalmodel/word-target-idx2word.npy').item()
        context = np.load('originalmodel/word-context.npy').item()
        ...
        self.model.load_weights('originalmodel/word-weights.h5')
...
model = ChatBot()
response = model.reply('hello')
print(response)

model.reply("whats going on?")
...
class ChatBot():
    ...
    def __init__(self):
        ...
        """
        self.input_word2idx = np.load('gitModel\\word-input-word2idx.npy').item()
        self.input_idx2word = np.load('gitModel\\word-input-idx2word.npy').item()
        self.target_word2idx = np.load('gitModel\\word-target-word2idx.npy').item()
        self.target_idx2word = np.load('gitModel\\word-target-idx2word.npy').item()
        context = np.load('gitModel\\word-context.npy').item()
        ...
        self.model.load_weights('gitModel\\word-weights.h5')

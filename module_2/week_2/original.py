...
MAX_VOCAB_SIZE = 100
DATA_PATH = os.path.join(currentDir, 'data/cornell movie-dialogs corpus/movie_lines.txt')
TENSORBOARD = os.path.join(currentDir, 'TensorBoard/')
WEIGHT_FILE_PATH = os.path.join(currentDir, 'originalmodel\\word-weights.h5')
...
np.save(os.path.join(currentDir, 'originalmodel\\word-input-word2idx.npy'), input_word2idx)
np.save(os.path.join(currentDir, 'originalmodel\\word-input-idx2word.npy'), input_idx2word)
np.save(os.path.join(currentDir, 'originalmodel\\word-target-word2idx.npy'), target_word2idx)
np.save(os.path.join(currentDir, 'originalmodel\\word-target-idx2word.npy'), target_idx2word)
...
np.save(os.path.join(currentDir, 'originalmodel\\word-context.npy'), context)
...
json = model.to_json()
open(os.path.join(currentDir, 'originalmodel\\word-architecture.json'), 'w').write(json)
